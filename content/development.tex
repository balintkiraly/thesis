...
A GraphQL Mutation–t (\refstruc{lst:login}) paraméterekkel ellátva szükséges megírnunk, hogy a kód generátor tudja lehetséges paramétereket. 
...
A generálást futtatva azonnal használhatjuk az elkészült hook–okat, a csatolt példában (\refstruc{lst:loginForm}) ez a useLoginMutation hook–ot.
